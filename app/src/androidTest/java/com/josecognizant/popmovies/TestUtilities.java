...
/**
 * Utilities for running tests on database and Content Provider
    ...
    public static void validateCurrentRecord(String error, Cursor valueCursor, ContentValues expectedValues) {
        ...
        for (Map.Entry<String, Object> entry : valueSet) {
            ...
            if (columnName.equals(MovieContract.MovieEntry.COLUMN_FAVORITE)) {
                assertEquals(MovieUtilities.isFavourite((int) entry.getValue()),
                        MovieUtilities.isFavourite(valueCursor.getInt(idx)));
            } else {
